...
export const forms = Array.from(document.querySelectorAll('.popup__input'));
...
export const popupEditSubmit = popupElementEdit.querySelector('.popup__button_submit');
...
export const buttonAddSubmit = popupElements.querySelector('.popup__button_submit');
